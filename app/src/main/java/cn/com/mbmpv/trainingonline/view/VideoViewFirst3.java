...
import cn.com.mbmpv.trainingonline.adapter.FirstVideoView3ListViewAdapter;
...
public class VideoViewFirst3 {
    ...
    Jianjie info;
    public VideoViewFirst3(Context mContext,Jianjie info) {
